Ez egy játék amit Pythonban fejlesztettem. A játék egy 2D-s rage game, ami a Cat Mariora hasonlít.
...
5. Futtassuk a main.py fájlt a "python main.py" paranccsal  ("-k nélkül a CLI-be írjuk bele).
